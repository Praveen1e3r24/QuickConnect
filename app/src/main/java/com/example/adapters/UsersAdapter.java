...
import com.example.listener.UsersListener;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder>{
    ...
    private List<com.example.models.User> users;
    private UsersListener usersListener;
    private List<com.example.models.User> selectedUsers;

    public UsersAdapter(List<com.example.models.User> users,UsersListener usersListener) {
        this.users = users;
        this.usersListener = usersListener;
        selectedUsers = new ArrayList<>();
    }

    public List<com.example.models.User> getSelectedUsers() {
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        UserViewHolder(@NonNull View itemView) {
            ...
            userContainer     = itemView.findViewById(R.id.item_container_user);
